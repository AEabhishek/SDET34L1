...
public class ListenerImplementation implements ITestListener {
	...
	test.addScreenCaptureFromPath(new WebDriverRepository(BaseClass.class.cast(result.getMethod().getInstance()).driver).takeScreenShot(result.getMethod().getMethodName(), BaseClass.class.cast(result.getMethod().getInstance())));
	}
	@Override
